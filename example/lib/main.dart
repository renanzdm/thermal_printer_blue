...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getBluetooth() async {
    final List bluetooths = await ThermalPrinterBlue.getBluetooths;
  ...
  Future<void> setConnect(String mac) async {
    final String result = await ThermalPrinterBlue.connect(mac);
  ...
  Future<void> printTicket() async {
    String isConnected = await ThermalPrinterBlue.connectionStatus;
    if (isConnected == "true") {
      List<int> bytes = await getTicket();
      final result = await ThermalPrinterBlue.writeBytes(bytes);
      print("Print $result");
    } else {
          ...
          child: Column(
            ...
            children: [
              RaisedButton(onPressed: () async {
                var res= await ThermalPrinterBlue.disconnect();
                print(res);
