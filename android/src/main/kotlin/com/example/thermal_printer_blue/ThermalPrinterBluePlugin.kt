package com.example.thermal_printer_blue
...
/** ThermalPrinterBluePlugin */
class ThermalPrinterBluePlugin : FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "thermal_printer_blue")
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    if (call.method == "getPlatformVersion") {
      ...
      if(bluetoothSocket?.isConnected == true){
        ...
        if(state == "true")
          result.success("successful disconnection")
      }
    }else if(call.method == "blueState"){
      var res : Boolean = bluetoothState()
      result.success(res)
  ...
  private suspend fun disconnect():String{
    state = "false"
    return  withContext(Dispatchers.IO) {
